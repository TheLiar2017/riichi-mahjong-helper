...
export const TILES: Tile[] = [
  ...
  { id: 'r5m', type: 'man', value: 5, name_ja: '赤五万', name_zh: '赤五万' },
  ...
  { id: 'r5p', type: 'pin', value: 5, name_ja: '赤五筒', name_zh: '赤五筒' },
  ...
  { id: 'r5s', type: 'sou', value: 5, name_ja: '赤五索', name_zh: '赤五索' },
...
// 赤宝牌 ID 列表
export const AKA_DORA_IDS = ['r5m', 'r5p', 'r5s'];
